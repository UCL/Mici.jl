```@meta
EditURL = "../../../examples/integrator_comparison_story.jl"
```
...
````
EuclideanSystem{PDMats.ScalMat{Float64}, Main.var"##2340".LoopProblem{Float64}}([1.0 0.0; 0.0 1.0], Main.var"##2340".LoopProblem{Float64}(0.2, 1.0))
````
...
fig
````
![](integrator_comparison_story-9.svg)
...
Reference step size: 0.05

| method | order | steps | time / traj | |ΔH| | accept |
| --- | --- | --- | --- | --- | --- |
| Leapfrog / StrangA | 2 | 20 | 0.005 ms | 6.353e-02 | 1.000 |
| Composition / StrangB | 2 | 20 | 1.886 ms | 2.512e-02 | 1.000 |
| Composition / McLachlan2 | 2 | 20 | 3.610 ms | 8.614e-03 | 1.000 |
| Composition / McLachlan4 | 4 | 20 | 13.654 ms | 1.827e-02 | 1.000 |
| Composition / TripleJump | 4 | 20 | 8.651 ms | 5.660e-03 | 0.994 |
| Composition / SuzukiFractal | 4 | 20 | 10.552 ms | 4.771e-04 | 1.000 |


## ESS report

Reference step size: 0.05, chain length: 1000, burnin: 200

| method | order | ESS | ESS/sec | accept |
| --- | --- | --- | --- | --- |
| Leapfrog / StrangA | 2 | 146.5 | 116.5 | 0.845 |
| Composition / StrangB | 2 | 201.5 | 66.0 | 0.861 |
| Composition / McLachlan2 | 2 | 184.2 | 36.7 | 0.983 |
| Composition / McLachlan4 | 4 | 210.0 | 18.8 | 0.965 |
| Composition / TripleJump | 4 | 134.9 | 20.1 | 0.888 |
| Composition / SuzukiFractal | 4 | 236.3 | 21.2 | 0.986 |
